  ...
  return (
    <div className="lg:min-h-[90vh] min-h-[100vh] mb-10 flex items-center justify-center bg-[#f4fff3] relative overflow-hidden px-4">
      <div className="relative">
        ...
        <div
          className="relative z-10 p-10 rounded-2xl shadow-md w-full max-w-2xl -rotate-[-1deg]"
          style={{
            background:
              "linear-gradient(to bottom right, hsla(141, 84%, 93%, 1), hsla(214, 95%, 93%, 1))",
            border: "3px solid hsla(141, 79%, 85%, 1)",
          }}
        >
          ...
          <p className="text-center text-gray-600 mb-6 text-sm">
            Get early access when we launch. Be among the first students to
            experience anonymous learning and streak accountability.
          </p>
