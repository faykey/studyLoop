  ...
  return (
    <div className="relative bg-[#f9fbfc] py-16 px-4 md:px-12 text-center overflow-hidden">
      ...
      <div className="mt-12 flex flex-col md:flex-row justify-center items-center gap-6 relative z-10">
        ...
        <div className="bg-purple-100 p-6 rounded-xl w-[280px] h-[200px] transform -rotate-2 shadow-md outline outline-1 outline-gray-300">
        ...
        <div className="bg-orange-100 p-6 rounded-xl w-[280px] h-[200px] transform rotate-1 shadow-md outline outline-1 outline-gray-300">
          <div className="text-3xl mb-2">🔥</div>
        ...
        <div className="bg-green-100 p-6 rounded-xl w-[280px] h-[200px] transform -rotate-1 shadow-md outline outline-1 outline-gray-300 relative">
          <div className="text-3xl mb-2">🧑‍🤝‍🧑</div>
