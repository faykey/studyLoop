    ...
    <div className="min-h-[90vh] flex items-center justify-center bg-white text-center relative overflow-hidden px-4">
      <div className="max-w-3xl mx-auto flex flex-col items-center">
        ...
        <div className="mt-8 flex gap-4 justify-center flex-wrap">
          ...
          <button
            className="bg-[hsla(217,91%,60%,1)] text-white w-[268px] h-[44px] px-8 rounded-[16px] font-semibold shadow-[0_4px_6px_hsla(199,80%,47%,1)] text-lg flex items-center justify-center gap-2"
          >
